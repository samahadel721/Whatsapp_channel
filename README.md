...
إذا وضعت `AUTO_FOLLOW_CHANNELS=true` فسيحاول البوت متابعة قنوات المراقبة تلقائيًا بعد الاتصال. إذا فشل ذلك، افتح الرابط في واتساب واضغط **متابعة** يدويًا.
